              ...
              return (
                <div key={i} className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  >
                    ...
                    <svg className={`w-5 h-5 text-gray-400 flex-shrink-0 transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true">
